...
`packages/sandbox/sandbox-policy/` (`@solsticeai/equinox-sandbox-policy`) registers `ctx.sandboxPolicy`, the single owner of the deployment's sandbox policy:
