...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@solsticeai/equinox-agent-loop`.
- No cross-package deep imports (`@solsticeai/equinox-*/src/...` paths) — public entry points only.
