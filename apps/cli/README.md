...
Bundles named in `dsh.profile.bundles` resolve from the dsh installation first (`@solsticeai/equinox-base`, `@solsticeai/equinox-web-app`, `@solsticeai/equinox-headless`, `@solsticeai/equinox-sdk-app`, `@solsticeai/equinox-sdk-minimal`, `@solsticeai/equinox-acp-app`), then from the profile's own `node_modules`, where pnpm installs out-of-tree plugins.
