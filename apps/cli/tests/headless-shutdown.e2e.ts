...
import { LOADER_SMOKE_TEST_TIMEOUT_MS, resolveExampleLaunch } from '@solsticeai/equinox-loader-smoke'
...
async function runHeadlessPtySmoke(): Promise<string> {
  ...
  try {
    ...
    await writeFile(join(profileDir, 'package.json'), JSON.stringify({
      ...
      private: true,
      dependencies: {},
      dsh: { profile: { bundles: ['@solsticeai/equinox-base', '@solsticeai/equinox-headless'] } },
    }, undefined, 2))
