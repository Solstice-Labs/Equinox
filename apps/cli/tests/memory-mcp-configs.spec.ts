...
import { boot, loadOverlayPatches } from '@solsticeai/equinox-app-boot'
import SystemPrompt from '@solsticeai/equinox-system-prompt'
import ToolRuntime from '@solsticeai/equinox-tools'
import * as McpClient from '@solsticeai/equinox-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@solsticeai/equinox-mcp-client')
