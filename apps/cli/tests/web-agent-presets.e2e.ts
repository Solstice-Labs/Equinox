...
import { boot, healProfilesModuleFallback, loadOverlayPatches, loadProfile } from '@solsticeai/equinox-app-boot'
import { provideCmdline } from '@solsticeai/equinox-cmdline'
import { SessionId, SessionLogOffset } from '@solsticeai/equinox-session'
import type { Agent } from '@solsticeai/equinox-agent'
import type { PatchOptions } from '@solsticeai/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it, vi } from 'vitest'
import { SUBAGENT_MODEL_SELECTION_SETTINGS_NAMESPACE } from '@solsticeai/equinox-tool-subagent/model-selection-settings'
import { SETTINGS_NAMESPACE, SHIPPED_PRESET_ROOT } from '@solsticeai/equinox-agent-presets'
import { applyChildComposition, childSessionMeta } from '@solsticeai/equinox-subagent'
import { ToolCallId } from '@solsticeai/equinox-llm'
import type {} from '@solsticeai/equinox-compaction-basic'
import type {} from '@solsticeai/equinox-skill'
import type {} from '@solsticeai/equinox-tools'
// Type-only: resolves `ctx.get('sessionProjections')` and `ctx.get('tokenMeter')`.
import type {} from '@solsticeai/equinox-session-projection'
import type {} from '@solsticeai/equinox-token-meter'
...
async function bootWeb(
  ...
  const overrides: PatchOptions[] = [
    ...
    { insert: [
      { id: 'directory-picker-browse', name: '@solsticeai/equinox-host-directory-picker-browse' },
      { id: 'ui-directory-picker-browse', name: '@solsticeai/equinox-client-ui-directory-picker-browse' },
    ] },
