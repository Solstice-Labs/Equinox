...
import { parseSessionLog } from '@solsticeai/equinox-llm-replay'
import type { SessionEvent, SessionId } from '@solsticeai/equinox-session'
import type {} from '@solsticeai/equinox-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@solsticeai/equinox-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@solsticeai/equinox-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@solsticeai/equinox-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@solsticeai/equinox-skill-filesystem"}\n',
