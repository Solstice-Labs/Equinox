...
import type {} from '@solsticeai/equinox-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@solsticeai/equinox-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@solsticeai/equinox-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
