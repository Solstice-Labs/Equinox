...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@solsticeai/equinox-my-cap'
...
```yaml
- name: '@solsticeai/equinox-my-cap-local'
- name: '@solsticeai/equinox-tool-my-cap'
```
