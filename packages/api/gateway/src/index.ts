 ...
 * @module @solsticeai/equinox-api-gateway
 */

import { randomUUID } from 'node:crypto'
import { Context, Service, symbols } from '@solsticeai/cordis'
import type { ConnectionRpcHandler } from '@solsticeai/equinox-client-connection'
import { Deque } from '@solsticeai/equinox-deque'
import type { WebUpgradeRoute } from '@solsticeai/equinox-host-webserver'
