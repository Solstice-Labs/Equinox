...
import type { PromptContentPart as AttachmentPromptContentPart } from '@solsticeai/equinox-attachment/types'
import { SessionSeq, type SessionSeqCursor } from '@solsticeai/equinox-session/types'
import {
