...
import { agentPresetProjectionDefinition } from '@solsticeai/equinox-agent-presets'
import type { Agent } from '@solsticeai/equinox-agent'
import { createUserMessage } from '@solsticeai/equinox-llm'
import SessionStore, { SessionId, SessionSeq } from '@solsticeai/equinox-session'
...
import SessionProjectionCache, { projectionCacheDomainSpec } from '@solsticeai/equinox-session-projection-cache'
...
import type { SessionControlFrame, SessionFollowFrame } from '@solsticeai/equinox-api-session-controller/types'
