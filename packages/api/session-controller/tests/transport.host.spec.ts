...
import type { Session, SessionEvent, SessionHeader, SurfaceIntent } from '@solsticeai/equinox-session'
...
import { subagentIdentityProjectionDefinition } from '@solsticeai/equinox-subagent/src/projection.ts'
