/**
 * @solsticeai/equinox-headless — one-shot direct Agent driver. The bundle patch
 ...
 *
 * @module @solsticeai/equinox-headless
 */
...
import type { Session, SessionEvent, SessionId, SessionLogOffset } from '@solsticeai/equinox-session'
// Empty type imports carry the loader Context merge for the settlement await
// and the cmdline Context merge for the appExit host value.
import type {} from '@solsticeai/cordis-plugin-loader'
import type {} from '@solsticeai/equinox-cmdline'
