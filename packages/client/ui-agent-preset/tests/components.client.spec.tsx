...
import { bindSnapshotSelector } from '@solsticeai/equinox-client-test-runtime'
...
describe('a refused switch', () => {
  it('announces the reason instead of letting the label snap back in silence', async () => {
    ...
    try {
      const reason = 'failed to import loader entry live-on-mac (@solsticeai/equinox-also-gone)'
