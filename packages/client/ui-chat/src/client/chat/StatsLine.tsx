...
import { Tooltip } from '@solsticeai/equinox-client-ui-primitives'
import type { UseProjection } from '@solsticeai/equinox-api-session-controller/client'
import type { SnapshotSelectorHook } from '@solsticeai/equinox-client-ui-slots'
// Type-only: merges the sessionStats key into SessionProjectionMap for useProjection.
import type {} from '@solsticeai/equinox-session-stats/client'
import type { TokenUsageProjection } from '@solsticeai/equinox-token-meter/client'
