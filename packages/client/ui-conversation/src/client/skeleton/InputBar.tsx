...
import type {} from '@solsticeai/equinox-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@solsticeai/equinox-goal/client'
...
import type { Translate } from '@solsticeai/equinox-client-ui-slots'
