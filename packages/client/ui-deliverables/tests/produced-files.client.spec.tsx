...
import type { ChatFileMentions, TurnTailOwnerProps } from '@solsticeai/equinox-client-ui-chat/client'
import { makeTranslate, RemoteError, stubSettingsScope } from '@solsticeai/equinox-client-test-runtime'
