...
import type { GoalSnapshot } from '@solsticeai/equinox-goal/client'
import {
...
import type { PropsLocale } from '@solsticeai/equinox-client-ui-slots'
...
export type GoalDockProps = import('@solsticeai/equinox-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
