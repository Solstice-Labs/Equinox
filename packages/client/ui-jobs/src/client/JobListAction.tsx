...
import type { SessionJob as JobView } from '@solsticeai/equinox-api-session-controller/types'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@solsticeai/equinox-client-ui-primitives'
import type { PropsLocale, PropsRuntime, TranslateNS } from '@solsticeai/equinox-client-ui-slots'
