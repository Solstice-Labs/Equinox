 ...
 * @module @solsticeai/equinox-client-ui-message-feedback/client/MessageFeedbackActions
 */
...
import type { MessageFeedbackRating } from '@solsticeai/equinox-message-feedback/types'
