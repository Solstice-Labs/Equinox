/**
 * Package-owned invariant companion for `@solsticeai/equinox-client-ui-renderer`.
 * @module @solsticeai/equinox-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@solsticeai/equinox-client-ui-slots'
import type { InvariantInstaller } from '@solsticeai/equinox-invariants'

const PACKAGE_NAME = '@solsticeai/equinox-client-ui-renderer'
