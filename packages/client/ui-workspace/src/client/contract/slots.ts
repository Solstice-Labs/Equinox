 ...
 */
import type { HostObservable, PropsHooks, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@solsticeai/equinox-client-ui-slots'
// Type-only: pull the owner SlotMap merges into programs that resolve the
// runtime shares below.
import type {} from '@solsticeai/equinox-client-ui-sidebar/client'
import type {} from '@solsticeai/equinox-client-ui-conversation/client'
import type { SessionSearchResultItem } from '@solsticeai/equinox-api-session-controller/client'
