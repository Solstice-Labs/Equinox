/** JSON string-prefix accounting for the outer-output ledger. @module @solsticeai/equinox-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@solsticeai/equinox-code-runtime'
