 ...
 *
 * @module @solsticeai/equinox-compaction-tool-result-pruner
 */

import { Context, Service } from '@solsticeai/cordis'
import z from '@solsticeai/schemastery'
import { freezeMessage } from '@solsticeai/equinox-llm'
import type { ContentBlock } from '@solsticeai/equinox-llm'
import type { Session, SessionEvent, SessionSeq, ToolResultMessage } from '@solsticeai/equinox-session'
