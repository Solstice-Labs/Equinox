 ...
 *
 * The seam itself lives in `@solsticeai/equinox-compaction`, which re-exports these
 ...
 *
 * @module @solsticeai/equinox-compaction/checkpoint
 */

import type { MessageSource } from '@solsticeai/equinox-llm/message'
