 ...
 *
 * @module @solsticeai/equinox-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@solsticeai/equinox-fs'
import { dshHomeDisplay } from '@solsticeai/equinox-home-paths'
