 ...
 * @module @solsticeai/equinox-agent-loop/invariant
 */

import type { Context } from '@solsticeai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@solsticeai/equinox-llm'
import type { InvariantFailure, InvariantInstaller } from '@solsticeai/equinox-invariants'
import { foldRequestHeader } from '@solsticeai/equinox-session'

const PACKAGE_NAME = '@solsticeai/equinox-agent-loop'
