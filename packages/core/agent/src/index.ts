...
import { Context, FiberState, getTraceable, Service, symbols } from '@solsticeai/cordis'
...
import type { SessionEvent, SessionId, SessionLogOffset } from '@solsticeai/equinox-session'
 ...
 * (`@solsticeai/equinox-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@solsticeai/equinox-agent#Agent',
