 ...
 * turn/step boundaries remain `@solsticeai/equinox-session` events.
 *
 * @module @solsticeai/equinox-agent
 */

import type { Context } from '@solsticeai/cordis'
import type { Scoped } from '@solsticeai/equinox-scope'
import type { LlmCallConfig, LlmFailure, ReasoningEffortId, ResolvedRetryPolicy } from '@solsticeai/equinox-llm'
import type { AgentCancelCause, Session, UserMessage } from '@solsticeai/equinox-session'
export type { AgentCancelCause } from '@solsticeai/equinox-session'
import type { Inbox } from './inbox.ts'
import type { Agent } from './types.ts'
export type { Agent } from './types.ts'
import type {} from '@solsticeai/equinox-system-prompt'
declare module '@solsticeai/equinox-system-prompt' {
...
declare module '@solsticeai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@solsticeai/equinox-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
