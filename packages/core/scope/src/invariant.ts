/** Package-owned scoped-dispatch invariants. @module @solsticeai/equinox-scope/invariant */

import type { Context } from '@solsticeai/cordis'
import type { InvariantInstaller } from '@solsticeai/equinox-invariants'
import { carrierKeyOf, isScopeCarrier } from '@solsticeai/equinox-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@solsticeai/equinox-scope'
