 ...
 *
 * @module @solsticeai/equinox-system-prompt
 */

import { Context, Service } from '@solsticeai/cordis'
import z from '@solsticeai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@solsticeai/equinox-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@solsticeai/equinox-scope'
import type { ContextSnapshotSection, ToolSchema } from '@solsticeai/equinox-llm'
...
declare module '@solsticeai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@solsticeai/equinox-scope`): scoped listeners
