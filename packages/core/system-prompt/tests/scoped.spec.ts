...
import { createScope, scopeOf } from '@solsticeai/equinox-scope'
import type { Scope, ScopeKey } from '@solsticeai/equinox-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@solsticeai/equinox-system-prompt'
import type { Config, PromptAssembly } from '@solsticeai/equinox-system-prompt'
