 ...
 * @module @solsticeai/equinox-tools/src/ptc
 */

import { brandString } from '@solsticeai/equinox-brand'
import { createUserMessage, HarnessError } from '@solsticeai/equinox-llm'
import type { ContentBlock, ToolCallId } from '@solsticeai/equinox-llm'
import type { CodeBindingFunction, CodeRunResult, CodeRuntime } from '@solsticeai/equinox-code-runtime'
import { snapshotJsonValue, type JsonValue } from '@solsticeai/equinox-util-values'
