...
import LlmRuntime, { createUserMessage, ToolCallId, HarnessError, type ContentBlock  } from '@solsticeai/equinox-llm'
...
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@solsticeai/equinox-user-approval'
import ToolRuntime, {
