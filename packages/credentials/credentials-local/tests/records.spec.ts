...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@solsticeai/equinox-credentials'
import type { CredentialKey, CredentialRecord } from '@solsticeai/equinox-credentials'
