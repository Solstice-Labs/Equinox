/**
 * Package-owned invariant companion for `@solsticeai/equinox-credentials`.
 * @module @solsticeai/equinox-credentials/invariant
 */
...
const PACKAGE_NAME = '@solsticeai/equinox-credentials'
