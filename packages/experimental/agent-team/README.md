...
- name: '@solsticeai/equinox-experimental-agent-team'
- name: '@solsticeai/equinox-experimental-tool-agent-team'
```
...
Each peer delivery adds the sender prefix plus message content to the target history. Task and roster mutations add no model tokens; their model-facing representation belongs to `@solsticeai/equinox-experimental-tool-agent-team` results.
