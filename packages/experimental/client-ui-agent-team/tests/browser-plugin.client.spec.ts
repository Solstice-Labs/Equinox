...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@solsticeai/equinox-experimental-agent-team/client'
import type {} from '@solsticeai/equinox-experimental-agent-team/remote'
import { RemoteError } from '@solsticeai/equinox-client-test-runtime'
import type { TypertRemoteContribution } from '@solsticeai/equinox-typert-protocol'
...
const REMOTE: TypertRemoteContribution = {
  package: '@solsticeai/equinox-experimental-agent-team',
  descriptors: [],
}
