...
import { MemoryVfs } from '@solsticeai/equinox-experimental-webworker-runtime/src/storage/memory.ts'
import { setActiveVfs } from '@solsticeai/equinox-experimental-webworker-runtime/src/storage/active.ts'
import { spawn, spawnSync } from '@solsticeai/equinox-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'
import {
  LAUNCHER_FAILURE_EXIT, grantArgs, launcherPath, probe,
} from '@solsticeai/node-addon-landlock-run'
import { processAlive, signalProcess } from '@solsticeai/equinox-experimental-webworker-runtime/src/node/process-table.ts'
import { hostFileSystem } from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/fs-access.ts'
import {
  LANDLOCK_EXECUTABLE, landlockFileSystem, parseLandlockArguments,
} from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/process/landlock.ts'
import { spawnSubprocess } from '@solsticeai/equinox-subprocess-local/src/spawn.ts'

vi.mock('node:child_process', async () =>
  await import('@solsticeai/equinox-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'))
