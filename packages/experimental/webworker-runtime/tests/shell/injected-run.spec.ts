...
import { filesystemError } from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/types.ts'
