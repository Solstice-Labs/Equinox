...
import { runShellCommand } from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/interpret.ts'
import type { ShellRunOutcome } from '@solsticeai/equinox-experimental-webworker-runtime/src/shell/types.ts'
