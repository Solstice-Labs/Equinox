 ...
 * @module @solsticeai/equinox-cordis-host-runner/guard
 */

import { Context } from '@solsticeai/cordis'
import type { Plugin } from '@solsticeai/cordis'
import { scopeOf } from '@solsticeai/equinox-scope'
import { assertSupportedJsonSchema, defineTool } from '@solsticeai/equinox-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@solsticeai/equinox-cordis-client-runner`, whose CTX_VERBS names this one its
