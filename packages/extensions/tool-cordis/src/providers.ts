...
import { HOST_BUILTIN_INSPECTION } from '@solsticeai/equinox-cordis-host-runner'
import type { HostCordisInspectProviderRegistration } from '@solsticeai/equinox-cordis-host-runner'
