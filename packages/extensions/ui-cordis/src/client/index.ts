...
import type {} from '@solsticeai/equinox-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@solsticeai/equinox-client-ui-input-trigger/client'
