...
import SessionStore, { foldSurface, Session, SessionId } from '@solsticeai/equinox-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@solsticeai/equinox-session-telemetry'
import * as commandFeedback from '@solsticeai/equinox-command-feedback'
...
vi.mock('@solsticeai/equinox-anonymous-user-id', () => ({
...
describe('@solsticeai/equinox-command-feedback registration', () => {
