 ...
 * ({@link module:@solsticeai/equinox-tool-fs-search/glob} /
 * {@link module:@solsticeai/equinox-tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @solsticeai/equinox-tool-fs-search
 */
