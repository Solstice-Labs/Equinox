 ...
 * model-facing render consumes ({@link module:@solsticeai/equinox-tool-fs-search/search-core}
 ...
 *
 * @module @solsticeai/equinox-tool-fs-search/presentation
 */
 ...
 * ({@link module:@solsticeai/equinox-tool-fs-search/grep} `formatGrepMatches`), so
