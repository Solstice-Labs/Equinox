 ...
 *
 * @module @solsticeai/equinox-tool-fs-search/search-core
 */
...
import { ItemRetainer, TextRetainer } from '@solsticeai/equinox-output-retention'
import type { RetainedItems } from '@solsticeai/equinox-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@solsticeai/equinox-subprocess'
import type { SaveTextSpill, SpillRef } from '@solsticeai/equinox-spill'
 ...
 * `@solsticeai/equinox-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@solsticeai/equinox-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@solsticeai/equinox-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@solsticeai/equinox-tool-fs-search/presentation} `grepSearchMeta`)
