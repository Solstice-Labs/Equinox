 ...
 * @module @solsticeai/equinox-command-goal
 */

import type { Context } from '@solsticeai/cordis'
import type { CommandInvocation, CommandResult } from '@solsticeai/equinox-commands'
import { GoalError } from '@solsticeai/equinox-goal'
import type { GoalPhase, GoalRef, GoalView } from '@solsticeai/equinox-goal'
