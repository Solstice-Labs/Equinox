/** Package-owned goal-round prompt invariants. @module @solsticeai/equinox-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@solsticeai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@solsticeai/equinox-goal'
...
const PACKAGE_NAME = '@solsticeai/equinox-goal-round-driver'
