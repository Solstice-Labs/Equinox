...
import { createUserMessage, HarnessError } from '@solsticeai/equinox-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@solsticeai/equinox-session'
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@solsticeai/equinox-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@solsticeai/equinox-session').SessionEvent[]): StubAgent {
