...
import GoalService, { GoalId, applyGoalProjection, foldGoal, goalProjectionDefinition } from '@solsticeai/equinox-goal'
import type { GoalProjection, GoalProjectionState, GoalRef } from '@solsticeai/equinox-goal'
