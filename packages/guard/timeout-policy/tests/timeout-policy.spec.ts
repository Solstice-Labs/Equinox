/**
 * Unit + real-load-path coverage for @solsticeai/equinox-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@solsticeai/equinox-llm'
import SystemPrompt from '@solsticeai/equinox-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@solsticeai/equinox-tools'
import * as timeoutPolicy from '@solsticeai/equinox-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@solsticeai/equinox-tool-call-timeout-policy'
