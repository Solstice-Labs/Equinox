/** Package-owned hook invocation/result stream invariants. @module @solsticeai/equinox-hook-protocol/invariant */
...
const PACKAGE_NAME = '@solsticeai/equinox-hook-protocol'
