...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@solsticeai/equinox-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@solsticeai/equinox-hook-protocol'
import type { RunHookOptions } from '@solsticeai/equinox-hook-protocol'
