 ...
 * @module @solsticeai/equinox-hooks-claude-code
 */

import { readFileSync } from 'node:fs'
import type { Context } from '@solsticeai/cordis'
import z from '@solsticeai/schemastery'
import type { Agent, PreStepDecision, TurnBoundaryProjection } from '@solsticeai/equinox-agent'
import type {} from '@solsticeai/equinox-session-projection'
import { createUserMessage } from '@solsticeai/equinox-llm'
import type { ContentBlock, MessageSource } from '@solsticeai/equinox-llm'
import type { UserMessage } from '@solsticeai/equinox-session'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@solsticeai/equinox-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@solsticeai/equinox-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@solsticeai/equinox-subagent'
