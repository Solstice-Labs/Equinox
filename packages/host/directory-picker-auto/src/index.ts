 ...
 * @module @solsticeai/equinox-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@solsticeai/equinox-host-directory-picker-native',
  browse: '@solsticeai/equinox-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@solsticeai/equinox-client-ui-directory-picker-native',
  browse: '@solsticeai/equinox-client-ui-directory-picker-browse',
}
