...
import HttpServer from '@solsticeai/equinox-host-webserver'
import type { DirectoryPicker } from '@solsticeai/equinox-host-directory-picker'
import BrowseDirectoryPicker from '@solsticeai/equinox-host-directory-picker-browse'
import NativeDirectoryPicker from '@solsticeai/equinox-host-directory-picker-native'
...
const AUTO = '@solsticeai/equinox-host-directory-picker-auto'
const NATIVE = '@solsticeai/equinox-host-directory-picker-native'
const BROWSE = '@solsticeai/equinox-host-directory-picker-browse'
const NATIVE_SURFACE = '@solsticeai/equinox-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@solsticeai/equinox-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@solsticeai/equinox-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@solsticeai/equinox-host-webserver', HttpServer],
