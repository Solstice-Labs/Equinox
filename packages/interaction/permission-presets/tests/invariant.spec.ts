...
import SessionStore, { SessionSeq, type Session, type SessionEvent } from '@solsticeai/equinox-session'
import * as PermissionInvariant from '@solsticeai/equinox-permission-presets/invariant'
