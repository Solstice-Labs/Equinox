...
import { carrierKeyOf, createScope } from '@solsticeai/equinox-scope'
...
import ApprovalService, { ApprovalOutcome, ApprovalRequest, setApprovalPolicy } from '@solsticeai/equinox-user-approval'
