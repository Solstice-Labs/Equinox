...
import FileSettingsProvider from '@solsticeai/equinox-settings-file'
import { getOrCreateAnonymousUserId } from '@solsticeai/equinox-anonymous-user-id'
import DeepSeekLlmApiExtensionRegistry from '@solsticeai/equinox-deepseek-llm-api-extensions'
import * as SessionLogDeepSeek from '@solsticeai/equinox-session-log-deepseek'
import * as DeepSeekPluginPackageInventory from '@solsticeai/equinox-plugin-package-inventory-deepseek'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    '- id: llm',
    "  name: '@solsticeai/equinox-llm'",
    '- id: session',
    "  name: '@solsticeai/equinox-session'",
    '- id: agents',
    "  name: '@solsticeai/equinox-agent'",
    '- id: deepseek-llm-api-extensions',
    "  name: '@solsticeai/equinox-deepseek-llm-api-extensions'",
    '- id: session-log-deepseek',
    "  name: '@solsticeai/equinox-session-log-deepseek'",
    ...options.enableSessionLog === true
      ? ['  config:', '    enabled: true']
      : [],
    '- id: plugin-package-inventory-deepseek',
    "  name: '@solsticeai/equinox-plugin-package-inventory-deepseek'",
    ...options.withDynamic
      ? [
        '- id: settings',
      ...
      : [],
    '- id: llm-deepseek',
    "  name: '@solsticeai/equinox-llm-deepseek'",
    '  config:',
  ...
  const modules = new Map<string, unknown>([
    ['@solsticeai/equinox-llm', LlmRuntime],
    ['@solsticeai/equinox-session', SessionStore],
    ['@solsticeai/equinox-agent', AgentRegistry],
    ['@solsticeai/equinox-deepseek-llm-api-extensions', DeepSeekLlmApiExtensionRegistry],
    ['@solsticeai/equinox-session-log-deepseek', SessionLogDeepSeek],
    ['@solsticeai/equinox-plugin-package-inventory-deepseek', DeepSeekPluginPackageInventory],
    ['@solsticeai/equinox-settings-file', FileSettingsProvider],
    ['@solsticeai/equinox-credentials-local', LocalCredentialProvider],
    ['@solsticeai/equinox-llm-deepseek', LlmDeepSeek],
  ])
...
describe('llm-deepseek real dynamic composition', () => {
  it('keeps session upload off and package inventory on by default in the real Loader composition', async () => {
    ...
    expect(request.dsh_plugin_packages.packages).toEqual(expect.arrayContaining([
      { name: '@solsticeai/equinox-deepseek-llm-api-extensions', version: '0.1.0-rc.8' },
      { name: '@solsticeai/equinox-llm-deepseek', version: '0.1.0-rc.8' },
      { name: '@solsticeai/equinox-session-log-deepseek', version: '0.1.0-rc.8' },
    ]))
