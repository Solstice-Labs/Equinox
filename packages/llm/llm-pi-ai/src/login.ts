...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@solsticeai/equinox-authorization'
import { isCredentialKeySegment } from '@solsticeai/equinox-credentials'
