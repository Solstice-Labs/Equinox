...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@solsticeai/equinox-llm'
import type { AppIdentity } from '@solsticeai/equinox-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `deepseek-harness/${manifest.version} (+https://github.com/Solstice-Labs/Equinox)`,
    )
  })
