...
import { LspInstance, readHostSource } from '@solsticeai/equinox-lsp-stdio'
import { encodeMessage } from '@solsticeai/equinox-lsp-stdio'
import type { ConnectionWriter } from '@solsticeai/equinox-lsp-stdio/src/connection.ts'
import type { InstanceSpec } from '@solsticeai/equinox-lsp-stdio/src/instance.ts'
import type { LspProviderQuery, LspQueryResult } from '@solsticeai/equinox-lsp'
