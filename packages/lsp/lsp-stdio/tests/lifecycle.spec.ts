...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@solsticeai/equinox-lsp'
import { deadline } from '@solsticeai/equinox-timeout'
...
import * as LspLocal from '@solsticeai/equinox-lsp-stdio'
import type { LspLocalServerConfig } from '@solsticeai/equinox-lsp-stdio'
