/**
 * Package-owned invariant companion for `@solsticeai/equinox-agent-presets`.
 * @module @solsticeai/equinox-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@solsticeai/equinox-agent-presets'

const PACKAGE_NAME = '@solsticeai/equinox-agent-presets'
