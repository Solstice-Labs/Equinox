 ...
 * @module @solsticeai/equinox-agent-presets/mount
 */

import { pathToFileURL } from 'node:url'
import { Context, type Fiber } from '@solsticeai/cordis'
import { Include } from '@solsticeai/cordis-plugin-include'
import type { EntryTree } from '@solsticeai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@solsticeai/equinox-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@solsticeai/equinox-*` row would fail to import. The
