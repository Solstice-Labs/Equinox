...
import AgentRegistry, { assembleContextFor } from '@solsticeai/equinox-agent'
import AgentLoop from '@solsticeai/equinox-agent-loop'
import InvariantRegistry from '@solsticeai/equinox-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@solsticeai/equinox-agent-presets'
import * as AgentPresetsInvariant from '@solsticeai/equinox-agent-presets/invariant'
