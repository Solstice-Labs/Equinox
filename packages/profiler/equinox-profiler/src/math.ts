/**
 * The dual-plane mathematical core of Project Equinox (tensor plane).
 *
 ...
 *
 * Asymmetric precision tiers (applied to scores normalized to [0, 1]):
...
import type { QuantTier } from './types.ts'
