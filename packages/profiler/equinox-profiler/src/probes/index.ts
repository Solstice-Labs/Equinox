import type { ProbeDomain } from '../types.ts'

import { CODING_PROBES } from './coding.ts'
import { INSTRUCTIONS_PROBES } from './instructions.ts'
import { LOGIC_PROBES } from './logic.ts'
import { SYNTAX_PROBES } from './syntax.ts'
import { TOOLS_PROBES } from './tools.ts'
import type { Probe } from './types.ts'

export type { Probe, ProbeFlow, ProbeFlowTurn } from './types.ts'
export { SYNTAX_PROBES } from './syntax.ts'
export { CODING_PROBES } from './coding.ts'
export { LOGIC_PROBES } from './logic.ts'
export { TOOLS_PROBES } from './tools.ts'
export { INSTRUCTIONS_PROBES } from './instructions.ts'
