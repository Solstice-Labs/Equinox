...
import { buildFingerprint, normalizeLayerImportance, quantPlanFromTiers } from '@solsticeai/profiler'
import type { LayerMoments, QuantTier } from '@solsticeai/core'
...
describe('quantPlanFromTiers', () => {
  it('groups consecutive rule entries per tier', () => {
    const plan = quantPlanFromTiers(
      [
        { layer: 0, tier: 'f16' as QuantTier },
        { layer: 1, tier: 'iq2_xxs' as QuantTier },
        { layer: 2, tier: 'q4_k_m' as QuantTier },
      ],
