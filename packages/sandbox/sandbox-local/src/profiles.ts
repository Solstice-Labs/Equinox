 ...
 *
 * @module @solsticeai/equinox-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@solsticeai/node-addon-landlock-run'
 ...
 * (`@solsticeai/equinox-fs-sandbox`) can never drift apart.
