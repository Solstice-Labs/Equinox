...
import { LAUNCHER_FAILURE_EXIT } from '@solsticeai/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@solsticeai/equinox-sandbox'
import type { SandboxPolicy } from '@solsticeai/equinox-sandbox'
import {
  LocalSandboxProvider,
} from '@solsticeai/equinox-sandbox-local'
import type { Config } from '@solsticeai/equinox-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @solsticeai/equinox-sandbox-windows-acl/tests/provider-chain.spec.ts
