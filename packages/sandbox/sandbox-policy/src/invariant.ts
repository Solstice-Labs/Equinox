/** Package-owned session-event invariants for sandbox policy. @module @solsticeai/equinox-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@solsticeai/equinox-sandbox-policy'
