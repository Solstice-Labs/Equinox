...
import {
  ...
  isNullPtr,
  throwLastError,
} from '@solsticeai/equinox-win32-process'
import type { NativePtr, Win32ProcessBindings } from '@solsticeai/equinox-win32-process'
...
export type { NativePtr } from '@solsticeai/equinox-win32-process'
