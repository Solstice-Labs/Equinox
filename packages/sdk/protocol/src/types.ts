 ...
 * plugin (`@solsticeai/equinox-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @solsticeai/equinox-sdk-protocol/types
 */
...
import type { SubagentStopReason } from '@solsticeai/equinox-subagent'
