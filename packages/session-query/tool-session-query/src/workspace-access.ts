 ...
 *
 * @module @solsticeai/equinox-tool-session-query/workspace-access
 */
...
import type { TurnBoundaryProjection } from '@solsticeai/equinox-agent'
import type {
  SessionLineageNode,
  SessionRecord,
} from '@solsticeai/equinox-session-query'
import type { ToolRunContext } from '@solsticeai/equinox-tools'
