 ...
 * @module @solsticeai/equinox-session-persistence-jsonl
 */
...
import type { SessionEvent, SessionId, SessionHeader, SessionLogOffset as SessionLogOffsetType } from '@solsticeai/equinox-session'
import {
