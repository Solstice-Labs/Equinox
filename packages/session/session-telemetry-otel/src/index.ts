 ...
 *
 * @module @solsticeai/equinox-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@solsticeai/schemastery'
import type { Context } from '@solsticeai/cordis'
import type {} from '@solsticeai/equinox-command-feedback'
import {
...
} from '@solsticeai/equinox-session-telemetry'
import { APP_IDENTITY } from '@solsticeai/equinox-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@solsticeai/equinox-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@solsticeai/equinox-session-telemetry-otel/ops', version)
