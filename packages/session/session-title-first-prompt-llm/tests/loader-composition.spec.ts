...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@solsticeai/equinox-llm'
...
import * as providerPlugin from '@solsticeai/equinox-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@solsticeai/equinox-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@solsticeai/equinox-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@solsticeai/equinox-session-title', SessionTitleService],
    ['@solsticeai/equinox-session-title-first-prompt-llm', providerPlugin],
  ])
