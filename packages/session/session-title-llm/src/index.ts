 ...
 * @module @solsticeai/equinox-session-title-llm
 */

import type { Context } from '@solsticeai/cordis'
import z from '@solsticeai/schemastery'
import { createUserMessage, BlockAssembler } from '@solsticeai/equinox-llm'
import type { FinishReason, GenerateOptions, Message } from '@solsticeai/equinox-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@solsticeai/equinox-timeout'
import { deepFreeze } from '@solsticeai/equinox-util-values'
import type { SessionSeq } from '@solsticeai/equinox-session'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@solsticeai/equinox-session-title'
import type {
