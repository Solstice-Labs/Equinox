/**
 * Package-owned invariant companion for `@solsticeai/equinox-session-title`.
 * @module @solsticeai/equinox-session-title/invariant
 */
...
const PACKAGE_NAME = '@solsticeai/equinox-session-title'
