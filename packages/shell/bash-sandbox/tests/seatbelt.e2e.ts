...
import { seatbeltProfileArgs } from '@solsticeai/equinox-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@solsticeai/equinox-sandbox-local`. Skips off macOS or when
