/**
 * Real-process tests for `@solsticeai/equinox-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@solsticeai/equinox-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@solsticeai/equinox-subprocess'
import { MAX_TIMER_DELAY_MS } from '@solsticeai/equinox-timeout'
import type { ShellProcess } from '@solsticeai/equinox-shell'
