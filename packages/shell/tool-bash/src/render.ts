 ...
 *
 * @module @solsticeai/equinox-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@solsticeai/equinox-shell'
import type { SandboxMode } from '@solsticeai/equinox-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@solsticeai/equinox-sandbox'
 ...
 * rendering story, owned by `@solsticeai/equinox-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@solsticeai/equinox-shell'
