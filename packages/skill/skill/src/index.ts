 ...
 * Concrete
 * providers such as `@solsticeai/equinox-skill-filesystem` decide where skills come
 ...
 *
 * @module @solsticeai/equinox-skill
 */

import { Context, Service } from '@solsticeai/cordis'
import type {} from '@solsticeai/equinox-llm'
import { assertNever } from '@solsticeai/equinox-util-values'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@solsticeai/equinox-scope'
