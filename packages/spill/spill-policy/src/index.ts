 ...
 * `@solsticeai/equinox-output-retention` (`TextRetainer`), storage is `ctx.spillStore`.
 ...
 *
 * @module @solsticeai/equinox-spill-policy
 */
...
import { TextRetainer, describeOmitted } from '@solsticeai/equinox-output-retention'
import type { Omitted } from '@solsticeai/equinox-output-retention'
...
import type { PostToolDecision, ToolExecution } from '@solsticeai/equinox-tools'
