/**
 * Package-owned invariant companion for `@solsticeai/equinox-storage-domain`: every
 ...
 * @module @solsticeai/equinox-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@solsticeai/equinox-storage-domain'
