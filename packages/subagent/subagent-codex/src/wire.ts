 ...
 *
 * @module @solsticeai/equinox-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@solsticeai/equinox-llm'
import type { SubagentResult } from '@solsticeai/equinox-subagent'
import { JsonRpcLineTransport } from '@solsticeai/equinox-sdk-protocol'
