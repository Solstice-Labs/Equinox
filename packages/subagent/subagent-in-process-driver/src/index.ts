 ...
 * one result.
 *
 * @module @solsticeai/equinox-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@solsticeai/cordis'
import { brandString } from '@solsticeai/equinox-brand'
import { foldConsumedWork } from '@solsticeai/equinox-agent'
import type { Agent, AgentHandle } from '@solsticeai/equinox-agent'
import { SessionLogOffset } from '@solsticeai/equinox-session'
import type { SessionEvent, SessionId, SessionLogOffset as SessionLogOffsetType, TurnEndReason } from '@solsticeai/equinox-session'
import { createUserMessage, type ContentBlock } from '@solsticeai/equinox-llm'
import {
