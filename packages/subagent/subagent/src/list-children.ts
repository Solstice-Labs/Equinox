...
import type { SessionProjectionCache } from '@solsticeai/equinox-session-projection-cache'
import type { SessionObservation, SessionQueryEngine } from '@solsticeai/equinox-session-query'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @solsticeai/equinox-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @solsticeai/equinox-session)',
  ...
  if (query === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionQuery service (load @solsticeai/equinox-session-query)',
