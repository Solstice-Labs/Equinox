 ...
 * `@solsticeai/equinox-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @solsticeai/equinox-tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@solsticeai/equinox-subagent/internal'
