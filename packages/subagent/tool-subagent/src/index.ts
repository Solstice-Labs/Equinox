 ...
 * @module @solsticeai/equinox-tool-subagent
 */

import type { Context } from '@solsticeai/cordis'
import z from '@solsticeai/schemastery'
import { scopeChainOf, scopeOf } from '@solsticeai/equinox-scope'
import { defineTool } from '@solsticeai/equinox-tools'
import type { Agent, AgentOptions } from '@solsticeai/equinox-agent'
...
import type { SubagentProvider, SubagentResult, SubagentRun } from '@solsticeai/equinox-subagent'
import type { JobOutcome } from '@solsticeai/equinox-jobs'
import {
...
export function apply(ctx: Context, config: Config): void {
  ...
  if (settings === undefined) {
    throw new Error(
      ...
      + '@solsticeai/equinox-tool-subagent/model-selection-settings in the Host scope',
    )
  }
