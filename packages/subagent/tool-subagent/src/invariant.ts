/**
 * Package-owned invariant companion for `@solsticeai/equinox-tool-subagent`.
 * @module @solsticeai/equinox-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@solsticeai/equinox-tool-subagent'
