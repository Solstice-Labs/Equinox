...
import type { ProcessInspectorInternals } from '@solsticeai/equinox-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@solsticeai/equinox-subprocess-local/src/windows-inspector.ts'
