 ...
 * @module @solsticeai/equinox-tool-terminal
 */
...
import { TerminalSessionId } from '@solsticeai/equinox-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@solsticeai/equinox-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @solsticeai/equinox-jobs and @solsticeai/equinox-tool-jobs')
