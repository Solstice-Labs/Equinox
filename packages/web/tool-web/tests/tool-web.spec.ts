...
import type { WebSearchProvider, WebSearchResult } from '@solsticeai/equinox-web'
...
} from '@solsticeai/equinox-tool-web'
import type { ContentBlock } from '@solsticeai/equinox-llm'
import type { ToolResult } from '@solsticeai/equinox-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@solsticeai/equinox-web').WebFetchProvider
