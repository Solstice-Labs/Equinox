...
import WebRuntime, { WebError } from '@solsticeai/equinox-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@solsticeai/equinox-web-search-deepseek'
import * as deepseekPlugin from '@solsticeai/equinox-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@solsticeai/equinox-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@solsticeai/equinox-web-search-deepseek'
