 ...
 * (`@solsticeai/equinox-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @solsticeai/equinox-tool-workflow
 */
...
import type { Session, SessionEventMap } from '@solsticeai/equinox-session'
