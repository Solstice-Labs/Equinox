 ...
 * @module @solsticeai/equinox-workflow-worker-thread/protocol
 */

import type { WorkflowAgentEndInfo, WorkflowAgentInfo, WorkflowResult } from '@solsticeai/equinox-workflow'
