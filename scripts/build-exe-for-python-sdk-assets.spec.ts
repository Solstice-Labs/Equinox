...
describe('Python runtime executable assets', () => {
  it('packages the dynamically resolved web frontend distribution', () => {
    ...
    expect(result.stdout).toContain('node_modules/@solsticeai/equinox-web-frontend/dist/**/*')
    expect(result.stdout).toContain('node_modules/@solsticeai/equinox-skill-badge/assets/**/*')
