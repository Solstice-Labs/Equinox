...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@solsticeai/equinox-typert-generator'
import type { CordisCatalogPolicy } from '@solsticeai/equinox-typert-generator'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  lightning: 'tensor-plane.md',
  profiler: 'tensor-plane.md',
  requant: 'tensor-plane.md',
  shell: 'shell.md',
  shellEnv: 'shell.md',
 ...
 * The scan that enforces this list reads EVERY `declare module '@solsticeai/cordis'`
 ...
 * scan reads EVERY `declare module '@solsticeai/cordis'` Events merge under
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ALL_PROBES: 'the 50-probe registry type is owned by packages/profiler/equinox-profiler/README.md',
  buildFingerprint: 'fingerprint builder contract is owned by packages/profiler/equinox-profiler/README.md',
  CommandExecution: 'executor return contract is owned by packages/interaction/commands/src/index.ts',
  EquinoxConfig: 'the Equinox configuration record is owned by packages/cloud/equinox-lightning/README.md',
  ModelProfile: 'the model profile record is owned by packages/profiler/equinox-profiler/README.md',
  runProbeSuite: 'probe-suite runner contract is owned by packages/profiler/equinox-profiler/README.md',
  runRequant: 're-quant runner contract is owned by packages/distiller/equinox-requant/README.md',
