...
import type { CordisCatalogModel, ServiceMethodEntry } from '@solsticeai/equinox-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@solsticeai/equinox-tool-cordis/api-catalog', '@solsticeai/equinox-cordis-client-runner/client/api-catalog')
