...
class ScopedEventGenerator {
  ...
  render(): string {
    ...
    return [
      ...
      ' *',
      ' * @module @solsticeai/equinox-scope/scoped-events.generated',
      ' */',
      '',
...
/** Return whether an Events interface is inside declare module '@solsticeai/cordis'. */
function isCordisModuleInterface(node: ts.InterfaceDeclaration): boolean {
  ...
  return ts.isModuleBlock(block)
    ...
    && declaration.name.text === '@solsticeai/cordis'
}
