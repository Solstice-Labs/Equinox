...
import type { ToolSchema } from '@solsticeai/equinox-llm'
...
import SqliteSessionQueryEngine from '@solsticeai/equinox-session-query-sqlite'
import GoalService from '@solsticeai/equinox-goal'
import SystemPrompt from '@solsticeai/equinox-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@solsticeai/equinox-tools'
import LocalBashExecutor from '@solsticeai/equinox-bash-local'
import * as BashEnvPlugin from '@solsticeai/equinox-shell-env'
import { PwshLocalExecutor } from '@solsticeai/equinox-pwsh-local'
...
import { AttachmentStore } from '@solsticeai/equinox-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@solsticeai/equinox-attachment'
import UserQuestionService from '@solsticeai/equinox-user-questions'
import PlanModeController from '@solsticeai/equinox-plan-mode'
import WebRuntime from '@solsticeai/equinox-web'
import * as WebSearchExa from '@solsticeai/equinox-web-search-exa'
import * as WebFetchLocal from '@solsticeai/equinox-web-fetch-http'
import SubagentRuntime from '@solsticeai/equinox-subagent'
import type { SubagentProvider } from '@solsticeai/equinox-subagent'
import * as ToolSubagentControl from '@solsticeai/equinox-tool-subagent-control'
import * as ToolSubagentListAgents from '@solsticeai/equinox-tool-subagent-control/list-agents'
import SkillRegistry from '@solsticeai/equinox-skill'
import * as SkillFileSystem from '@solsticeai/equinox-skill-filesystem'
import LocalJobRegistry from '@solsticeai/equinox-jobs-local'
import * as ToolAskUser from '@solsticeai/equinox-tool-ask-user'
import * as ToolBash from '@solsticeai/equinox-tool-bash'
import * as ToolPwsh from '@solsticeai/equinox-tool-pwsh'
import * as ToolBashPersistent from '@solsticeai/equinox-tool-bash-persistent'
import * as ToolPwshPersistent from '@solsticeai/equinox-tool-pwsh-persistent'
import CordisHostRunner from '@solsticeai/equinox-cordis-host-runner'
import * as ToolCordis from '@solsticeai/equinox-tool-cordis'
import * as ToolFs from '@solsticeai/equinox-tool-fs'
import * as ToolFsSearch from '@solsticeai/equinox-tool-fs-search'
import * as ToolStrReplaceEditor from '@solsticeai/equinox-tool-str-replace-editor'
...
import * as ToolSchedule from '@solsticeai/equinox-schedule'
import Lsp from '@solsticeai/equinox-lsp'
import * as ToolLsp from '@solsticeai/equinox-tool-lsp'
import * as ToolSkill from '@solsticeai/equinox-tool-skill'
...
import type TeamService from '@solsticeai/equinox-experimental-agent-team'
import * as ToolTeam from '@solsticeai/equinox-experimental-tool-agent-team'
import * as ToolTodo from '@solsticeai/equinox-tool-todo'
import * as ToolSubagent from '@solsticeai/equinox-tool-subagent'
import { registerListSubagentModels } from '../packages/subagent/tool-subagent/src/list-models.ts'
import * as ToolWeb from '@solsticeai/equinox-tool-web'
import VmWorkflowEngine from '@solsticeai/equinox-workflow-worker-thread'
import * as ToolRalph from '@solsticeai/equinox-tool-ralph'
import * as ToolWorkflow from '@solsticeai/equinox-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@solsticeai/equinox-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@solsticeai/equinox-plan-mode',
    dir: 'plan-mode',
  ...
  {
    pkg: '@solsticeai/equinox-tool-bash',
    dir: 'tool-bash',
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@solsticeai/equinox-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@solsticeai/equinox-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@solsticeai/equinox-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `DSH_*` environment comes from `@solsticeai/equinox-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@solsticeai/equinox-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@solsticeai/equinox-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or DSH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@solsticeai/equinox-tool-bash-persistent',
  ...
  {
    pkg: '@solsticeai/equinox-tool-pwsh-persistent',
  ...
  {
    pkg: '@solsticeai/equinox-tool-str-replace-editor',
  ...
  {
    pkg: '@solsticeai/equinox-tool-fs',
    dir: 'tool-fs',
    ...
    note:
      'The read-before-write/edit policy is added by `@solsticeai/equinox-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@solsticeai/equinox-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@solsticeai/equinox-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@solsticeai/equinox-tool-goal',
    dir: 'tool-goal',
  ...
  {
    pkg: '@solsticeai/equinox-schedule',
    dir: 'schedule',
  ...
  {
    pkg: '@solsticeai/equinox-tool-lsp',
    dir: 'tool-lsp',
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@solsticeai/equinox-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@solsticeai/equinox-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@solsticeai/equinox-tool-skill',
    dir: 'tool-skill',
  ...
  {
    pkg: '@solsticeai/equinox-tool-session-query',
  ...
  {
    pkg: '@solsticeai/equinox-tool-subagent',
    dir: 'tool-subagent',
    source: {
  ...
  {
    pkg: '@solsticeai/equinox-tool-subagent-control',
  ...
  {
    pkg: '@solsticeai/equinox-tool-jobs',
    dir: 'tool-jobs',
  ...
  {
    pkg: '@solsticeai/equinox-experimental-tool-agent-team',
    dir: 'tool-agent-team',
  ...
  {
    pkg: '@solsticeai/equinox-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@solsticeai/equinox-tool-workflow',
    dir: 'tool-workflow',
  ...
  {
    pkg: '@solsticeai/equinox-tool-web',
    dir: 'tool-web',
