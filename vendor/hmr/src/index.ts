import { Context, Service, type Plugin } from '@solsticeai/cordis'
import type { Dict } from '@solsticeai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@solsticeai/cordis-plugin-loader'
import type { Include } from '@solsticeai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@solsticeai/cordis-plugin-timer'
